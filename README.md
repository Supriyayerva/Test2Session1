<br> 1.	Write a program to find the distance between two pointsvoid 
		<br> void input(float \*x1, float \*y1, float \*x2, float \*y2);
		<br> rea);
		<br> void output(float x1, float y1,float x2, float y2, float area);find_distance(float x1, float y1, float x2, float y2, float *a
		<br> input:
		<br> 1 1 2 2
		<br> output:
